...
class server_configuration_command(models.Model):
    ...
    _name = 'it_infrastructure.server_configuration_command'
    _description = 'server_configuration_command'
    _inherit = ['it_infrastructure.command']
    ...
    #     if server_id:
    #         server = recs.env['it_infrastructure.server'].browse(server_id)
    ...
    def execute_command(self, cr, uid, ids, context=None):
        ...
        if not server_id:
            ...
            print 'no server_id on context'
            return False
        server = self.pool['it_infrastructure.server'].browse(
