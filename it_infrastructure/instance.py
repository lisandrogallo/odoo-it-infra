...
class instance(models.Model):
    ...
    # activo
    _name = 'it_infrastructure.instance'
    ...
    _track = {
        'state': {
            'it_infrastructure.instance_draft':
            lambda self, cr, uid, obj, ctx=None: obj['state'] == 'draft',
            'it_infrastructure.instance_active':
            lambda self, cr, uid, obj, ctx=None: obj['state'] == 'active',
            'it_infrastructure.instance_cancel':
    ...
    instance_host_ids = fields.One2many(
        'it_infrastructure.instance_host',
        'instance_id',
        string='Hosts'
    )
    ...
    def action_wkf_set_draft(self, cr, uid, ids, *args):
        ...
        for obj_id in ids:
            wf_service.trg_delete(uid, 'it_infrastructure.instance', obj_id, cr)
            wf_service.trg_create(uid, 'it_infrastructure.instance', obj_id, cr)
        return True
