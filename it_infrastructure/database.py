...
class database(models.Model):
    ...
    # Modulos instalados
    # Ultimo acceso
    _name = 'it_infrastructure.database'
    ...
    backup_ids = fields.One2many(
        'it_infrastructure.database.backup',
        'database_id',
        string='Backups',
        readonly=False
    )
    ...
    def action_wfk_set_draft(self, cr, uid, ids, *args):
        ...
        for obj_id in ids:
            wf_service.trg_delete(uid, 'it_infrastructure.database', obj_id, cr)
            wf_service.trg_create(uid, 'it_infrastructure.database', obj_id, cr)
        return True
